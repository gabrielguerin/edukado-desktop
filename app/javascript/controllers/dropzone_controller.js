...
Dropzone.prototype.defaultOptions.dictFallbackMessage = "Votre navigateur ne vous permet pas de télécharger vos fichiers en les déposant.";
Dropzone.prototype.defaultOptions.dictFallbackText = "Veuillez utiliser le formulaire suivant pour télécharger vos fichiers comme au bon vieux temps.";
Dropzone.prototype.defaultOptions.dictFileTooBig = "Le fichier est trop volumineux ({{filesize}}}Mo). Taille maximale : {{maxFilesize}}Mo.";
Dropzone.prototype.defaultOptions.dictInvalidFileType = "Vous ne pouvez pas télécharger des fichiers de ce type.";
