...
class YearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create year" do
    assert_difference('Year.count') do
      post years_url, params: { year: { end_year: @year.end_year, start_year: @year.start_year } }
    end
  ...
  test "should update year" do
    patch year_url(@year), params: { year: { end_year: @year.end_year, start_year: @year.start_year } }
